...
- `selectorOptions` - setting the mechanism of the selectors. You can also enable or disable error suppression in selectors.
...
@NgModule({
  imports: [
    NgxsModule.forRoot(states, NGXS_CONFIG)
  ],
  ...
})
