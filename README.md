...
| **NGXS Signals**          | [`@ngxs/signals`](https://npmjs.com/package/@ngxs/signals)                   | [![latest](https://img.shields.io/npm/v/%40ngxs%2Fsignals/latest.svg)](https://npmjs.com/package/@ngxs/signals)                   | [![README](https://img.shields.io/badge/README--green.svg)](https://github.com/ngxs/store/blob/master/docs/concepts/select/signals.md) [![snapshot](https://img.shields.io/badge/snapshot--blue.svg)](https://www.npmjs.com/package/@ngxs/signals/v/dev)    |
