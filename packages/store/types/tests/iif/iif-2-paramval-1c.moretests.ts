...
type Operator3<P> = StateOperator<P> | StateOperator2<P>; // Same as Original
// type Operator<P> = StateOperator2<P>;

type OperatorOrValuez<T, P, V> = T extends unknown
  ? Operator1<P> | NotAFunction<V, V extends P ? V : never> // ? StateOperator<P> | NotAFunction<V, V extends P ? V : never>
  : StateOperator<T> | T | NotAFunction<V, T>;

type OperatorOrValue<T, P, V> = OperatorOrValuez<T, P, V>;

export declare function iif<T, P extends T = T, V extends T = T>(
