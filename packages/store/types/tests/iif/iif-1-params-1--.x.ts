...
type StateOperatorA_<T, P extends T> = (existing: Readonly<P>) => T;
...
type OperatorOrValueA<T, P extends T> = StateOperatorA_<T, P> | T | NotAFunction<P, P>;
 ...
 */
export declare function iif<T, P1 extends T = T, P2 extends T = T>(
  condition: Predicate<NoInfer<T>> | boolean,
  trueOperatorOrValue: OperatorOrValueA<NoInfer<T>, P1>,
  elseOperatorOrValue?: OperatorOrValueA<NoInfer<T>, P2>
): StateOperator_<T, P1 | P2>;
