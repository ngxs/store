...
/**
 * The SelectUtils namespace is used for logical grouping of functionalities.
 */
export namespace SelectUtils {
  export function selectBySelector<T = any>(selector: any): Observable<T> {
  ...
  export function unwrapSelector(name: string, rawSelector?: any, paths: string[] = []): any {
