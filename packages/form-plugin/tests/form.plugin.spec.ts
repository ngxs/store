...
import { NgxsFormPluginModule, UpdateForm, UpdateFormDirty, UpdateFormErrors,
    UpdateFormStatus, UpdateFormValue, SetFormDirty, SetFormDisabled,
    SetFormEnabled, SetFormPristine } from '../';
...
describe('NgxsFormPlugin', () => {
  ...
  it('should update form errors', () => {
    ...
    const store = TestBed.get(Store);
    store.dispatch(new UpdateFormErrors({
